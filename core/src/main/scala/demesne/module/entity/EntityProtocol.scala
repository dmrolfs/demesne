...
trait EntityProtocol[I] extends AggregateProtocol[I] {
  ...
  case class Added( override val sourceId: Added#TID, info: Option[Any] = None ) extends Event
  case class Renamed( override val sourceId: Renamed#TID, oldName: String, newName: String ) extends Event
  case class Reslugged( override val sourceId: Reslugged#TID, oldSlug: String, newSlug: String ) extends Event
  case class Disabled( override val sourceId: Disabled#TID, slug: String ) extends Event
  case class Enabled( override val sourceId: Enabled#TID, slug: String ) extends Event
}
